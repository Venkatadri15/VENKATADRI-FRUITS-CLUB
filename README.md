...
<body>
        ...
        <div class="container">
            ...
            <div class="contact-container">
                <div class="contact-info">
                    ...
                    <p><i class="fas fa-envelope"></i> fruitsclub.atp@gmail.com</p>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // Load any existing admin orders from localStorage
            loadAdminOrders();
            loadFruitsFromStorage();
            loadUserOrders();
        });
        ...
        function loadUserOrders() {
            const savedOrders = localStorage.getItem('fruitsClubUserOrders');
            if (savedOrders) {
        ...
        function loginAdmin(user) {
            ...
            document.querySelector('.user-avatar').textContent = 'A';
            
            // Render admin dashboard
            renderAdminDashboard();
            updateAdminPanel();
            
            showNotification(`Welcome, ${user.firstName}!`);
        ...
        // Update user order status
        function updateUserOrderStatus(orderId, status) {
